...
| Property | Value |
| --- | --- |
| Project | 26d80853-3563-4d97-b8d3-6f7713a85b43 |
| Scan Date | 2026-04-02 |
| Java Files | 884 |
| Total Findings | 893 |
| Diagrams Generated | 63 |
...
| /Consumerdelete | GET | MODERATE | ~118ms | ~295ms | 0 |
| /mapbrands | GET | FAST | ~43ms | ~107ms | 0 |
| /mapbrands | PUT | MODERATE | ~103ms | ~257ms | 0 |
| /mapbrands | DELETE | MODERATE | ~103ms | ~257ms | 0 |
| /mapcars | GET | FAST | ~43ms | ~107ms | 0 |
| /mapcars | PUT | MODERATE | ~103ms | ~257ms | 0 |
| /mapcars | DELETE | MODERATE | ~103ms | ~257ms | 0 |
...
| /mapmodels | PUT | MODERATE | ~103ms | ~257ms | 0 |
| /mapmodels | DELETE | MODERATE | ~103ms | ~257ms | 0 |
...
| /authentication/authenticateUsingGet | GET | FAST | ~43ms | ~107ms | 0 |
...
| 7 | D11-001 | CRITICAL | Hardcoded credential — API_KEY_NOT_VALIDATED in AuthConstant | N/A |
| 8 | D11-001 | CRITICAL | Hardcoded credential — API_KEY in AuthentiationServiceImpl | N/A |
| 9 | D11-001 | CRITICAL | Hardcoded credential — TOKEN_DATE_FORMAT in AuthentiationServiceImpl | N/A |
| 10 | D6-001 | CRITICAL | SQL INJECTION — string concatenation in insert() | N/A |
| 11 | D6-001 | CRITICAL | SQL INJECTION — string concatenation in generate() | N/A |
| 12 | D6-001 | CRITICAL | SQL INJECTION — string concatenation in generate() | N/A |
| 13 | D11-001 | CRITICAL | Hardcoded credential — API_KEY in ConsumerFlowConfigurationJpaRepository | N/A |
| 14 | D11-001 | CRITICAL | Hardcoded credential — API_KEY in ConsumerJpaRepository | N/A |
| 15 | D11-001 | CRITICAL | Hardcoded credential — API_KEY in Constants | N/A |
| 16 | D11-001 | CRITICAL | Hardcoded credential — API_KEY_SPLIT in Constants | N/A |
| 17 | D6-001 | CRITICAL | SQL INJECTION — string concatenation in byVehicleIdentificationNumber() | N/A |
| 18 | D11-001 | CRITICAL | Hardcoded credential — NULL_API_KEY in ResponseMessages | N/A |
| 19 | D11-001 | CRITICAL | Hardcoded credential — EMPTY_API_KEY in ResponseMessages | N/A |
| 20 | D11-001 | CRITICAL | Hardcoded credential — INVALID_API_KEY in ResponseMessages | N/A |
